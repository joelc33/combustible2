...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('autenticar/usuario/proceso/guardar') }}" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="usuario" value="{{ $data['id_tab_usuario'] }}">
        <div class="block">
            <div class="block-header block-header-default">
                <a class="btn btn-light" href="{{ URL::to('autenticar/usuario/proceso').'/'.$data['id_tab_usuario'] }}">
