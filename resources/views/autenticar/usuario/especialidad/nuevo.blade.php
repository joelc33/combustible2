...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('configuracion/usuario/especialidad/guardar') }}" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="id_usuario" value="{{ $data['id_usuario'] }}">
        <div class="block">
            <div class="block-header block-header-default">
                <a class="btn btn-light" href="{{ URL::to('configuracion/usuario/especialidad').'/'.$data['id_usuario'] }}">
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('especialidad') ? 'is-invalid' : '' !!}" name="id_especialidad" id="id_especialidad" {{ $errors->has('especialidad') ? 'aria-describedby="especialidad-error" aria-invalid="true"' : '' }}>
