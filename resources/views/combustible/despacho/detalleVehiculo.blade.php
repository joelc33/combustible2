...
@section('js_after')
   ...
   <script>
        $('#borrar').on('show.bs.modal', function (event) {
            $("#borrarForm").attr('action','{{ url('/combustible/despacho/eliminar') }}');
...
<div class="content content-full content-boxed">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <a class="btn btn-light" href="{{ URL::to('combustible/despacho/listaGerencia').'/'.$id  }}">
                ...
                @foreach($tab_vehiculo as $key => $value)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" title="Quitar Vehiculo" data-target="#borrar" data-item_id="{{ $value->id_despacho }}" >
