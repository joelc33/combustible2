...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('combustible/despacho/guardarApoyo') }}" method="POST">
...
<!--                                    <div class="input-group-append">
                        ...
                        <div class="form-group form-row"> 
                            <div class="col-4">
                                <label for="litro">Cant. Litros</label>
                                <div class="input-group">
                                            <input type="text" class="form-control {!! $errors->has('litro') ? 'is-invalid' : '' !!}" id="litro" name="litro" placeholder="litro..." value="{{ old('litro') }}" {{ $errors->has('litro') ? 'aria-describedby="litro-error" aria-invalid="true"' : '' }}>
                                            @if( $errors->has('litro') )
                        ...
                        <label for="observacion">Observación</label>
                         <textarea  class="form-control {!! $errors->has('observacion') ? 'is-invalid' : '' !!}" id="observacion" name="observacion" placeholder="observacion..."  {{ $errors->has('observacion') ? 'aria-describedby="observacion-error" aria-invalid="true"' : '' }}></textarea>
