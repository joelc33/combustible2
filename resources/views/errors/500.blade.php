        ...
        <div class="hero-inner">
            <div class="content content-full">
                <div class="px-3 py-5 text-center">
                    ...
                    <h2 class="h3 font-w400 text-muted mb-5 invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="450">Lo sentimos, pero su solicitud contiene una sintaxis incorrecta y no se puede cumplir...</h2>
