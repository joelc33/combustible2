...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('configuracion/solicitud/guardar').'/'.$data->id }}" method="POST">
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('identificador') ? 'is-invalid' : '' !!}" id="identificador" name="identificador" placeholder="N° Identificador..." value="{{ empty(old('identificador'))? $data->nu_identificador : old('identificador') }}" {{ $errors->has('identificador') ? 'aria-describedby="identificador-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('descripcion') ? 'is-invalid' : '' !!}" id="descripcion" name="descripcion" placeholder="Descripcion..." value="{{ empty(old('descripcion'))? $data->de_solicitud : old('descripcion') }}" {{ $errors->has('descripcion') ? 'aria-describedby="descripcion-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox custom-control-primary mb-1">
                                <input type="checkbox" class="custom-control-input" id="visible" name="visible" @if ($data->in_ver == true) checked @endif >
