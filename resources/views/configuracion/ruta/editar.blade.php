...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('configuracion/ruta/guardar').'/'.$data->id }}" method="POST">
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('proceso') ? 'is-invalid' : '' !!}" name="proceso" id="proceso" {{ $errors->has('proceso') ? 'aria-describedby="proceso-error" aria-invalid="true"' : '' }}>
                                @foreach($tab_proceso as $proceso)
                                    <option value="{{ $proceso->id }}" {{ $proceso->id == $data->id_tab_proceso ? 'selected' : '' }}>{{ $proceso->de_proceso }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('orden') ? 'is-invalid' : '' !!}" id="orden" name="orden" placeholder="N° Orden..." value="{{ empty(old('orden'))? $data->nu_orden : old('orden') }}" {{ $errors->has('orden') ? 'aria-describedby="orden-error" aria-invalid="true"' : '' }}>
                            @if( $errors->has('orden') )
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox custom-control-primary mb-1">
                                <input type="checkbox" class="custom-control-input" id="in_datos" name="in_datos" @if ($data->in_datos == true) checked @endif >
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('entorno') ? 'is-invalid' : '' !!}" name="entorno" id="entorno" {{ $errors->has('entorno') ? 'aria-describedby="entorno-error" aria-invalid="true"' : '' }}>
                                @foreach($tab_entorno as $entorno)
                                    <option value="{{ $entorno->id }}" {{ $entorno->id == $data->id_tab_entorno ? 'selected' : '' }}>{{ $entorno->de_entorno }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('controlador') ? 'is-invalid' : '' !!}" id="controlador" name="controlador" placeholder="Controlador..." value="{{ empty(old('controlador'))? $data->nb_controlador : old('controlador') }}" {{ $errors->has('controlador') ? 'aria-describedby="controlador-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('accion') ? 'is-invalid' : '' !!}" id="accion" name="accion" placeholder="Accion..." value="{{ empty(old('accion'))? $data->nb_accion : old('accion') }}" {{ $errors->has('accion') ? 'aria-describedby="accion-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('reporte') ? 'is-invalid' : '' !!}" id="reporte" name="reporte" placeholder="Reporte..." value="{{ empty(old('reporte'))? $data->nb_reporte : old('reporte') }}" {{ $errors->has('reporte') ? 'aria-describedby="reporte-error" aria-invalid="true"' : '' }}>
