...
@section('js_after')
    ...
    <script>
        $('#borrar').on('show.bs.modal', function (event) {           
            ...
            var modal = $(this);
            $("#borrarForm").attr('action','{{ url('/configuracion/instituto/eliminar').'/'}}'+item_id);
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn-block-option mr-2"><a href="{{ URL::to('configuracion/instituto/nuevo')}}"><i class="fa fa-plus mr-1"></i> Nuevo</a></button>
        ...
        <div class="block-content">
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                @foreach($tab_instituto as $key => $value)
                    <tr>
                        <td class="font-w600">{{ $value->de_instituto }}</td>                       
                        <td class="text-center">
                            <div class="btn-group">
                               <a href="{{ url('/configuracion/instituto/editar').'/'. $value->id }}">
            ...
            {{ $tab_instituto->appends(Request::only(['perPage','q']))->render() }}         
