...
class Utiles
{
   public static function numletras( $xcifra, $_moneda)
   {
      $xarray = array(0 => "Cero",
  ...
  //
      ...
      $_moneda=1=BOLIVARES, 2=Dólares 3=Euros
      ...
      */
      ...
      {
      case 1:
      $_nommoneda='BOLIVARES SOBERANOS';
      break;
      case 2:
      $_nommoneda='DOLARES';
      break;
      ...
      for ($xz = 0; $xz < 3; $xz++) {
          ...
          if (trim($xaux) != "") {
              switch ($xz) {
                  ...
                  case 2:
                      if ($xcifra < 1) {
                          $xcadena = "CERO ".$_nommoneda." CON ".$xdecimales."/100.";
                      }
                      if ($xcifra >= 1 && $xcifra < 2) {
                          $xcadena = "UN ".$_nommoneda." CON ".$xdecimales."/100. ";
                      }
                      if ($xcifra >= 2) {
                          $xcadena.= " ".$_nommoneda." CON ".$xdecimales."/100. "; //
                      }
                      break;
              } // endswitch ($xz)
          } // ENDIF (trim($xaux) != "")
