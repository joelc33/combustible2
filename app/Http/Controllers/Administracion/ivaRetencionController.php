...
class ivaRetencionController extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.ivaRetencion.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.ivaRetencion.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_iva_retencion::select( 'id', 'nu_iva_retencion', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.ivaRetencion.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
            ...
            $validador = Validator::make( $request->all(), tab_iva_retencion::$validarEditar);
            if ($validador->fails()) {
            ...
            try {
                ...
                $tabla = tab_iva_retencion::find($id);
                $tabla->nu_iva_retencion = $request->descripcion; 
                $tabla->save();

                DB::commit();

                Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
                return Redirect::to('/administracion/ivaRetencion/lista');
            ...
            $validador = Validator::make( $request->all(), tab_iva_retencion::$validarCrear);
            if ($validador->fails()) {
                return Redirect::back()->withErrors( $validador)->withInput( $request->all());
            }
