...
class tipoCuentaBancaria extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.tipoCuentaBancaria.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.tipoCuentaBancaria.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_tipo_cuenta_bancaria::select( 'id', 'de_tipo_cuenta_bancaria', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.tipoCuentaBancaria.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
          ...
          $validador = Validator::make( $request->all(), tab_tipo_cuenta_bancaria::$validarEditar);
          if ($validador->fails()) {
          ...
          try {
            ...
            $tabla = tab_tipo_cuenta_bancaria::find($id);
            $tabla->de_tipo_cuenta_bancaria = $request->descripcion;
            $tabla->save();

            DB::commit();

            Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
            return Redirect::to('/administracion/tipoCuentaBancaria/lista');
          ...
          $validador = Validator::make( $request->all(), tab_tipo_cuenta_bancaria::$validarCrear);
          if ($validador->fails()) {
              return Redirect::back()->withErrors( $validador)->withInput( $request->all());
          }
          ...
          try {
            ...
            $tabla = new tab_tipo_cuenta_bancaria;
            $tabla->de_tipo_cuenta_bancaria = $request->descripcion;
    ...
    public function eliminar( Request $request)
    {
      ...
      try {
        ...
        $tabla = tab_tipo_cuenta_bancaria::find( $request->get("id"));
        $tabla->delete();
