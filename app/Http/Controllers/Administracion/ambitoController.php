...
class ambitoController extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.ambito.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.ambito.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_ambito::select( 'id', 'nu_ambito', 'de_ambito', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.ambito.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
          ...
          $validador = Validator::make( $request->all(), tab_ambito::$validarEditar);
          if ($validador->fails()) {
          ...
          try {
            ...
            $tabla = tab_ambito::find($id);
            $tabla->nu_ambito = $request->codigo;
            $tabla->de_ambito = $request->descripcion;
            $tabla->save();

            DB::commit();

            Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
            return Redirect::to('/administracion/ambito/lista');
          ...
          $validador = Validator::make( $request->all(), tab_ambito::$validarCrear);
          if ($validador->fails()) {
              return Redirect::back()->withErrors( $validador)->withInput( $request->all());
          }
