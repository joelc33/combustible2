...
class tipoPresupuestoController extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.tipoPresupuesto.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.tipoPresupuesto.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_tipo_presupuesto::select( 'id', 'de_tipo_presupuesto', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.tipoPresupuesto.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
          ...
          $validador = Validator::make( $request->all(), tab_tipo_presupuesto::$validarEditar);
          if ($validador->fails()) {
          ...
          try {
            ...
            $tabla = tab_tipo_presupuesto::find($id);
            $tabla->de_tipo_presupuesto = $request->descripcion; 
            $tabla->save();

            DB::commit();

            Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
            return Redirect::to('/administracion/tipoPresupuesto/lista');
          ...
          $validador = Validator::make( $request->all(), tab_tipo_presupuesto::$validarCrear);
          if ($validador->fails()) {
              return Redirect::back()->withErrors( $validador)->withInput( $request->all());
          }
          ...
          try {
            ...
            $tabla = new tab_tipo_presupuesto;
            $tabla->de_tipo_presupuesto = $request->descripcion;
    ...
    public function eliminar( Request $request)
    {
      ...
      try {
        ...
        $tabla = tab_tipo_presupuesto::find( $request->get("id"));
        $tabla->delete();
