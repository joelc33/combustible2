...
class aplicacionController extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.aplicacion.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.aplicacion.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_aplicacion::select( 'id', 'nu_aplicacion', 'de_aplicacion', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.aplicacion.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
          ...
          $validador = Validator::make( $request->all(), tab_aplicacion::$validarEditar);
          if ($validador->fails()) {
          ...
          try {
            ...
            $tabla->nu_aplicacion = $request->codigo;
            $tabla->de_aplicacion = $request->descripcion;
            $tabla->save();

            DB::commit();

            Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
            return Redirect::to('/administracion/aplicacion/lista');
          ...
          $validador = Validator::make( $request->all(), tab_aplicacion::$validarCrear);
          if ($validador->fails()) {
              return Redirect::back()->withErrors( $validador)->withInput( $request->all());
          }
    ...
    public function eliminar( Request $request)
    {
      ...
      try {
        ...
        $tabla = tab_aplicacion::find( $request->get("id"));
        $tabla->delete();
