...
class tipoProveedorController extends Controller
{
    ...
    */
    public function lista( Request $request)
    {
        ...
        return View::make('administracion.tipoProveedor.lista')->with([
    ...
    public function nuevo()
    {
        ...
        return View::make('administracion.tipoProveedor.nuevo')->with([
            'data'  => $data
        ]);
    }
    ...
    {
        $data = tab_tipo_proveedor::select( 'id', 'de_tipo_proveedor', 'in_activo', 'created_at', 'updated_at')
        ->where('id', '=', $id)
        ->first();

        return View::make('administracion.tipoProveedor.editar')->with([
            'data'  => $data
        ]);
    }
    ...
    public function guardar(Request $request, $id = NULL)
    {
        ...
        if($id!=''||$id!=null){
            ...
            $validador = Validator::make( $request->all(), tab_tipo_proveedor::$validarEditar);
            if ($validador->fails()) {
            ...
            try {
                ...
                $tabla = tab_tipo_proveedor::find($id);
                $tabla->de_tipo_proveedor = $request->descripcion; 
                $tabla->save();

                DB::commit();

                Session::flash('msg_side_overlay', 'Registro Editado con Exito!');
                return Redirect::to('/administracion/tipoProveedor/lista');
            ...
            $validador = Validator::make( $request->all(), tab_tipo_proveedor::$validarCrear);
            if ($validador->fails()) {
                return Redirect::back()->withErrors( $validador)->withInput( $request->all());
            }
